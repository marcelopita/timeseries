...
public class mlp {
	...
	//Atributo que indica o n�mero de camadas escondidas.
	private static int numHidden;

	//Atributo que indica o n�mero de entradas.
	private static int numInputs;

	//Atributo que indica o n�mero de sa�das.
	private static int numOutputs;

	//Atributo que indica a quantidade de �pocas.

	private static int ciclos;
	//Atributo que indica o  ciclo atual.
	private static int cicloAtual;
	
	//Atributo que indica o n�mero de treinamentos.
	...
	//Atributo que indica o valor da semente do gerador de n�meros aleat�rios.
	...
	/**
	 * Retorna o n�mero de exemplos de treinamento.
	 * @return
	 */
	...
	/**
	 * Atribui o n�mero de exemplos de treinamento.
	 * @param value
	 */
	...
	/**
	 * Retorna o n�mero de neur�nios escondidos.
	 * @return
	 */
	...
	/**
	 * Atribui o n�mero de neur�nios escondidos.
	 * @param value
	 */
	...
	/**
	 * Atribui o valor do bias1 no �ndice indicado.
	...
	/**
	 * Retorna o valor do bias1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do bias2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do bias2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do netin1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do netin1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do sum1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor da sensibilidade no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Retorna o valor do fnet1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do fnet1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do Antigodeltabs2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do Antigodeltabs1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Atribui o valor do Antigodeltabs2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do Antigodeltabs1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do delbs1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do deltabs1 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
	...
	/**
	 * Atribui o valor do deltabs2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 * @param value: valor que ser� atribu�do.
	 */
	...
	/**
	 * Retorna o valor do deltabs2 no �ndice indicado.
	 * @param index: �ndice do vetor.
	 */
		...
		for(int kl=0; kl<getCiclos(); kl++) {
			...
			for(int itr=0; itr<getNumTraining(); itr++) {
				...
				for(int j=0;j<getNumOutputs();j++) {
					...
					System.out.println("Sa�da desejada:"+" "  +  getSaidas(itr,j)+ "  "+ "Sa�da calculada:" 
					+" " +getNetout(itr,j));
